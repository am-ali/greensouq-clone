...
export default function Footer({ showNewsletter = true }: { showNewsletter?: boolean }) {
      ...
      {showNewsletter && (
        <div className="bg-white py-12">
          <div className="max-w-screen-2xl mx-auto px-6 text-center">
            ...
            <p className="text-gray-600 mb-6">Invite customers to join your mailing list.</p>
            <div className="flex justify-center gap-2 max-w-md mx-auto">
              <input
                type="email"
                placeholder="Email address"
                className="flex-1 px-4 py-3 border border-gray-300 rounded focus:outline-none focus:border-gray-400"
              />
              <button className="bg-black text-white px-8 py-3 rounded font-medium hover:bg-gray-800">
                Sign up
              </button>
            </div>
          </div>
  ...
  <div className="max-w-screen-2xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          {/* Hot Links */}
          <div>
            <h4 className="font-semibold mb-4">Hot Links</h4>
            <ul className="space-y-2 text-sm">
